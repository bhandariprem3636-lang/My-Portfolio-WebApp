      ...
      <div className="flex">
          ...
          <div>
            <div>
              ...
              <div className="h-2 rounded-full m-4 bg-gray-200">
                <div className="h-2 w-[95%] rounded-full bg-gradient-to-r from-[#00F5FF] via-[#3B82F6] to-[#8B5CF6]"></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 rounded-full m-4 bg-gray-200">
                <div className="h-2 w-[90%] rounded-full bg-gradient-to-r from-[#00F5FF] via-[#3B82F6] to-[#8B5CF6]"></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 rounded-full m-4 bg-gray-200">
                <div className="h-2 w-[85%] rounded-full bg-gradient-to-r from-[#00F5FF] via-[#3B82F6] to-[#8B5CF6]"></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 rounded-full m-4 bg-gray-200">
                <div className="h-2 w-[80%] rounded-full bg-gradient-to-r from-[#00F5FF] via-[#3B82F6] to-[#8B5CF6]"></div>
              </div>
            </div>
        ...
        <div className="flex m-10">
          <div className="h-50 w-170 rounded-xl shadow-2xl/50">
            <div className="flex m-4 gap-2">
              <div className="p-2 rounded-full bg-gradient-to-r from-emerald-300 via-green-400 to-lime-300">
           ...
           <div className="flex">
            ...
            <p className="text-center mt-3 font-bold text-white">GIT</p>
              ...
              <div className="flex flex-col justify-center items-center m-4 h-25 w-40 shadow-2xl/40 rounded-xl">
            <img src={GitHub} alt=" github-logo" className="ml-5 mr-5 mt-0 h-17 w-21"/>
            <p className="text-center mt-1 font-bold text-white">GITHUB</p>
            </div>

             <div className="flex flex-col justify-center items-center m-4 h-25 w-40 shadow-2xl/40 rounded-xl">
            <img src={canva} alt=" canva-logo" className="ml-5 mr-5 mt-0 h-17 w-21"/>
